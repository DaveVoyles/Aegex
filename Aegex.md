...
TODO: The majority of your win artifacts will be included in this section, including 
(but not limited to) the following: Pictures, drawings, architectural diagrams, 
value stream mappings and demo videos. What was worked on and what problem it helped solve.
...
The deployed software running on the device is a Universal Windows Platform app with the 
Windows IoT Extension SDK. This SDK allowed the device to access the GPIO pins to manage 
...
regarding the flame sensor. The messages are sent from the device to the cloud permitting 
internet connection. The code is available [here](https://github.com/kottofy/ThePiFiles).
...
an SQL Azure database. By doing this, the data is permanently stored and can be utilized 
...
# Technical delivery
TODO This section will include the following details of how the solution was implemented:
...
- Windows 10 IoT Core 10.0.14393.576
- C#/XAML UWP App
- Windows IoT Extension SDK
- TODO data packet size and freq of send
- TODO Security: How are the devices, data and apps being secured?
- TODO Is the POC planned to go into production and what is the anticipated timeline?


# Future Opportunities

- Guardian Center Conference!
- Machine Learning application to detect anomolies

# Conclusion 
TODO This section will briefly summarize the technical story with the following details included:
...
TODO: Remove this: **Directions for adding images:**
